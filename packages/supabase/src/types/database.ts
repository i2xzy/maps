...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      features: {
        Row: {
          ...
          id: string
          name: string
          phase: Database["public"]["Enums"]["feature_phase"]
      ...
      grouping_features: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "grouping_features_grouping_id_fkey"
            columns: ["grouping_id"]
            isOneToOne: false
      ...
      groupings: {
        Row: {
          ...
          id: string
          name: string
          type: Database["public"]["Enums"]["grouping_type"]
          url: string | null
          zone: string | null
        }
        Insert: {
      ...
      temp_features: {
        Row: {
          ...
          plan_name_2: string | null
          plan_name_3: string | null
          plan_url: string | null
          plan_url_2: string | null
          plan_url_3: string | null
          route_element_id: string | null
          status: string | null
          type: string | null
        }
    ...
    Enums: {
      feature_phase: "phase1" | "phase2a" | "phase2b"
      feature_status:
        | "NOT_STARTED"
        | "PREP_WORK"
        | "FOUNDATIONS"
      ...
      feature_type:
        ...
        | "station"
        | "culvert"
      grouping_type: "plan_sheet" | "embankment" | "cutting" | "station_area"
