...
// Type-only: load the TipTap command augmentations these controls call
// (toggleSubscript, setTextAlign, setFontFamily, toggleHighlight, …) so the file
// type-checks wherever it's compiled, with no runtime import. StarterKit covers
// bold/italic/underline/strike/code/link/lists/headings/history.
